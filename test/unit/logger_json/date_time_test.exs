defmodule LoggerJSON.DateTimeTest do
  ...
  test "date" do
    Logger.configure_backend(LoggerJSON, metadata: [:date])
    Logger.metadata(date: ~D[2021-07-02])
    ...
    assert %{"date" => "2021-07-02"} == log["metadata"]
  end
end
